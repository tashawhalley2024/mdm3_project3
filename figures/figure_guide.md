...
**What the result means.** **Composite:** T1 β = **−0.226 (p < 0.001)**; T2 β = **+0.061 (p = 0.07)**. Strong cross-country signal; within-country mildly positive and marginal under clustered SEs (tightens to p < 0.001 under Driscoll–Kraay HAC with the same point estimate). The sign flip between tiers is the core empirical puzzle and is resolved at figure 12. **Apostasy:** T1 β = −0.119 (p < 0.01); T2 β = −0.018 (p = 0.07, p < 0.01 under DK). Consistent sign across tiers; the only sub-item whose within-country signal survives. **Courts:** T1 β = +0.017 (n.s.); T2 β = −0.007 (n.s.). Null in both. The other GRI variables cluster around zero, consistent with the composite summarising them.
...
**What the result means.** **Composite within-effect:** β ≈ +0.061 (p ≈ 0.06) — small, wrong-signed for the prior. **Composite between-effect:** β ≈ −0.278 (p < 0.001) — large, correctly signed, tightly estimated. The between-to-within ratio in magnitude is roughly **4.5×**, and the two estimates point in opposite directions. The composite secularism story is overwhelmingly cross-national: countries at different points on the secularism spectrum look systematically different on women's welfare, and the structural gap between them dwarfs any within-country movement over the 2013–2022 window. This reframes the interpretation: the paper supports the claim that *more secular countries have better women's welfare*, but it does not provide positive evidence that *a country moving toward secularism will see women's welfare improve within a decade*.
...
**What the result means.** Composite 2013→2022 with GDP: β = +0.082 (p = 0.28, N = 163, 158 changers) — wrong-signed for the prior, not significant. The within-country null therefore persists at the decade horizon rather than resolving at it: annual noise and WVS interpolation cannot be the binding explanation for the T2/T4 within null.
